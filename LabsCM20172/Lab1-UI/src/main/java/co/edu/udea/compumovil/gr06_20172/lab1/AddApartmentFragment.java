...
public class AddApartmentFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        txtValidateR[0]=(EditText)view.findViewById(R.id.addressApartamento);
        txtValidateR[1]=(EditText)view.findViewById(R.id.NombreApartamento);
        txtValidateR[2]=(EditText)view.findViewById(R.id.tipoApartamento);
        txtValidateR[3]=(EditText)view.findViewById(R.id.valorApartamento);
        txtValidateR[4]=(EditText)view.findViewById(R.id.AreaApartamento);
        txtValidateR[5]=(EditText)view.findViewById(R.id.DescripciónApartamento);
    ...
    public void ValidarPlaces() {//valida los lugares, que ya esten en la BD
        ...
        values.put(StatusContract.Column_Apartment.ADDRESS,txtValidateR[0].getText().toString());
        values.put(StatusContract.Column_Apartment.NAME,txtValidateR[1].getText().toString());
        values.put(StatusContract.Column_Apartment.TYPE, txtValidateR[2].getText().toString());
        values.put(StatusContract.Column_Apartment.VALUE, txtValidateR[3].getText().toString());
        values.put(StatusContract.Column_Apartment.AREA, txtValidateR[4].getText().toString());
        values.put(StatusContract.Column_Apartment.DESCRYPTION, txtValidateR[5].getText().toString());
